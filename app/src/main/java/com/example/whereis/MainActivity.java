...
import com.example.whereis.image.ImageClassificationActivity;
import com.example.whereis.object.ObjectDetectionActivity;
...
public class MainActivity extends AppCompatActivity implements AlgoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Algo(R.drawable.baseline_center_focus_strong_24, "Save Object", ImageClassificationActivity.class));
        arrayList.add(new Algo(android.R.drawable.ic_menu_search, "Find Object", ImageSearchActivity.class));
